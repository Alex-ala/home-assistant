...
SUPPORT_ROOMBAi7 = SUPPORT_BATTERY | SUPPORT_PAUSE | SUPPORT_RETURN_HOME | SUPPORT_STATUS | SUPPORT_STOP | \
...
async def async_setup_platform(
    ...
    try:
        with async_timeout.timeout(9):
            await hass.async_add_job(roombai7.connect)
...
class Roombai7Vacuum(VacuumDevice):
    """Representation of a Roomba Vacuum cleaner robot."""

    def __init__(self, name, roombai7):
